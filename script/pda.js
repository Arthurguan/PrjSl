...
function getworkcenterUrl(){
		return getServerUrl()+"padController!getAllWorkCenter.m";
}
function getworkcellUrl(){
		return getServerUrl()+"padController!getWorkCell.m";
}
function getworkcellbyworkcenterUrl(){
        return getServerUrl()+"padController!getWorkCenter.m";
}
